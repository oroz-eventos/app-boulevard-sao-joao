...
export const MAP_MARKERS: MapMarker[] = [
  ...
  // === 4 PALCOS DO CIRCUITO MUSICAL (curadoria por localização · mídia kit final) ===
  {
    id: 'palco-mpb-samba',
    kind: 'palcos',
    title: 'Palco MPB / Samba',
    subtitle: 'Cruzamento São João × Ipiranga · roda de samba e MPB',
    x: 72, y: 48,
    ...
    detailHref: '/circuitos/musical',
  },
  {
    id: 'palco-rock',
    kind: 'palcos',
    title: 'Palco Rock',
    subtitle: 'Largo do Paissandu · rock paulistano e indie',
    x: 90, y: 24,
    color: KIND_COLORS.palcos,
  ...
  },
  {
    ...
    kind: 'palcos',
    title: 'Palco Hip Hop',
    subtitle: 'Correios / Anhangabaú · rap, trap e dança urbana',
    x: 12, y: 42,
    color: KIND_COLORS.palcos,
  ...
  },
  {
    id: 'palco-jazz',
    kind: 'palcos',
    title: 'Palco World Music / Jazz',
    subtitle: 'Rua dos Timbiras · jazz, world music e instrumental',
    x: 38, y: 62,
    color: KIND_COLORS.palcos,
