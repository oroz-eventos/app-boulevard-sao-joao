...
export const INTERAJA_SLIDES: InterajaSlide[] = [
  {
    ...
    description: 'Tire uma foto com realidade aumentada e apareça como se estivesse em uma tela gigante estilo Times Square.',
    expiresInHours: 60,
  ...
  },
  {
    ...
    description: 'Responda perguntas rápidas, some pontos em tempo real e acompanhe seu ranking com o público do evento.',
    expiresInHours: 20,
  ...
  },
  {
    ...
    description: 'Grave, envie e reserve um horário para aparecer no telão do Boulevard com sua mensagem ou reação.',
    expiresInHours: 147,
    participantsLabel: '427 pessoas já participaram',
    actionLabel: 'Começar',
    imageUri: 'https://images.unsplash.com/photo-1492691527719-9d1e07e534b4?auto=format&fit=crop&w=1200&q=80',
  },
]

export const KIND_LABELS: Record<InterajaSlide['kind'], string> = {
